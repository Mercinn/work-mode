# Work Mode – Stay Focused, Stay Productive
...
Download or clone this repository:
 ...
 ``git clone https://github.com/Mercinn/work-mode.git``

Open Google Chrome and go to `chrome://extensions/`.

Enable Developer Mode (located in the top right of the page).

Click "Load Unpacked" and select the work-mode project folder.
...
Navigate to the 'Options' tab and add websites to your blacklist by inputting the website URL and hitting the 'Add' button.

Navigate back to the 'Home' tab and press the 'Activate' button to activate the website blocker.
